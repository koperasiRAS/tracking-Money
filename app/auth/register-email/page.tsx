...
import { registerWithEmail } from "@/lib/actions/register";
...
export default function RegisterEmailPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After successful registration, redirect to 2FA enrollment
    ...
    <main className="min-h-screen flex bg-base">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0f0f23] via-[#0d1f2d] to-[#0a2a1a]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 py-16 w-full">
          ...
          <p className="text-white/50 text-lg mb-16 max-w-md leading-relaxed">
            Daftar dengan email dan password untuk mulai melacak portofolio saham Anda.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white dark:bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Daftar dengan Email</h2>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Buat akun baru dengan email dan password.</p>
          </div>
          ...
          <Link
            href="/auth/register"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl font-medium text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm"
          >
